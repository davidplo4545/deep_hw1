# PART1 DATASETS.py assasafsdfsdfdsfdsfd
...
def random_labelled_image(
    ...
    if dtype.is_floating_point:
        ...
        # Scale and shift values to fit the specified range
    ...
    label = torch.randint(0, num_classes, (1,), dtype = int).item()
...
class SubsetDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if index >= self.subset_len or index + self.offset >= len(self.source_dataset):
